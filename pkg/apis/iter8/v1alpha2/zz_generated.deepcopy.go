...
func (in *Assessment) DeepCopyInto(out *Assessment) {
	*out = *in
	...
	if in.Candidates != nil {
		...
		*out = make([]CandidateAssessment, len(*in))
		for i := range *in {
...
func (in *CandidateAssessment) DeepCopyInto(out *CandidateAssessment) {
	*out = *in
	in.CandidateAssessment.DeepCopyInto(&out.CandidateAssessment)
	return
}
...
func (in *ExperimentStatus) DeepCopyInto(out *ExperimentStatus) {
	*out = *in
	...
	if in.LastIncrementTime != nil {
		in, out := &in.LastIncrementTime, &out.LastIncrementTime
		*out = (*in).DeepCopy()
	}
