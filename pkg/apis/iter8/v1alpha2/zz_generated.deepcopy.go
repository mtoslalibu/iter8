...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExperimentManualOverride) DeepCopyInto(out *ExperimentManualOverride) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExperimentManualOverride.
func (in *ExperimentManualOverride) DeepCopy() *ExperimentManualOverride {
	if in == nil {
		return nil
	}
	out := new(ExperimentManualOverride)
	in.DeepCopyInto(out)
	return out
}
